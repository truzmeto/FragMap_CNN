...
#SBATCH --job-name=m_jupy  # Assign an short name to your job 
...
##SBATCH --constraint=titan             # specifies to use the Pacal Node which has the P10
...
srun jupyter lab --no-browser --ip=0.0.0.0 --port=8889
